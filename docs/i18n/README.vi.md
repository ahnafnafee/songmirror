...
- 📻 **Last.fm**: đưa Loved Tracks, Top Tracks (sáu khoảng thời gian) và Recent Scrobbles của bạn tới bất kỳ dịch vụ đã kết nối, và sau khi cấp quyền cho tài khoản, mang các bài hát yêu thích từ dịch vụ khác trở lại **vào** Last.fm. Việc đồng bộ danh sách phát tới dịch vụ này không được hỗ trợ nên không bao giờ là đích đến của danh sách phát.
...
1. Đăng nhập trên trang Amazon Music của khu vực bạn và mở DevTools → Mạng.
...
Việc đồng bộ danh sách phát tới Last.fm không được hỗ trợ nên không bao giờ là đích đến của danh sách phát. Nó góp **lịch sử nghe** dưới dạng các bộ sưu tập chỉ đọc, và **Loved Tracks** của nó là một bộ sưu tập bài hát yêu thích giống như ở mọi nhà cung cấp khác, và trở nên ghi được khi bạn cấp quyền cho tài khoản.
