...
- 📻 **Last.fm**：把你的 Loved Tracks、Top Tracks（六个时间段）和 Recent Scrobbles 同步到任意已连接的服务；授权账户后，还能把其他服务的喜欢歌曲同步回 **Last.fm**。它没有歌单，因此永远不会成为歌单目标。
...
Last.fm 没有歌单，因此永远不会成为歌单目标。它以只读集合的形式提供你的**收听记录**，其中的 **Loved Tracks** 与其他所有服务的喜欢歌曲集合一样，在你授权账户后即可写入。
